-- ========================================================================
-- PHARMACY MANAGEMENT & INTERNSHIP SYSTEM - DATABASE SCHEMA
-- 18 Processes with Full RBAC Integration
-- ========================================================================
...
(1, 'Customer', 'Regular customer - Can upload prescriptions and process payments'),
(2, 'Intern', 'Pharmacy intern - Can submit internship requirements and access assigned processes'),
(3, 'Pharmacist Assistant', 'Assistant to pharmacist - Can dispense products and check availability'),
(4, 'Pharmacy Technician', 'Pharmacy technician - Manages inventory and stock'),
(5, 'Pharmacist', 'Licensed pharmacist - Approves requisitions and generates POs'),
(6, 'HR Personnel', 'Human resources personnel - Manages policies, interviews, schedules');

-- ========================================================================
-- PROCESS 1: INTERN REQUIREMENT SUBMISSION
-- ========================================================================
...
-- ========================================================================
-- PROCESS 2: HR POLICIES & GUIDELINES
-- ========================================================================
...
-- ========================================================================
-- PROCESS 4: INTERVIEW MANAGEMENT
-- ========================================================================
...
-- ========================================================================
-- PROCESS 5 & 6: INTERNSHIP SCHEDULING
-- ========================================================================
...
-- ========================================================================
-- PROCESS 9 & 10: INVENTORY COUNTS & REPORTS
-- ========================================================================
...
-- ========================================================================
-- PROCESS 16 & 17: PRODUCTS & DISPENSING
-- ========================================================================
...
-- ========================================================================
-- MISSING TABLES — run these if they don't exist yet
-- ========================================================================
CREATE TABLE IF NOT EXISTS intern_tasks (
    id INT PRIMARY KEY AUTO_INCREMENT,
    intern_id INT NOT NULL,
...
-- ========================================================================
-- SAMPLE TEST DATA (password: password123)
-- ========================================================================
...
INSERT IGNORE INTO products (id, product_code, product_name, description, category, manufacturer_id, unit_price, cost_price, current_stock, reorder_level) VALUES
(1, 'MED-001', 'Amoxicillin 500mg', 'Antibiotic capsule', 'Antibiotics', 1, 15.00, 8.00, 200, 50),
(2, 'MED-002', 'Paracetamol 500mg', 'Pain reliever and fever reducer', 'Analgesics', 1, 5.00, 2.50, 500, 100),
(3, 'MED-003', 'Metformin 500mg', 'Oral diabetes medicine', 'Antidiabetics', 2, 12.00, 6.00, 150, 50),
(4, 'MED-004', 'Losartan 50mg', 'Blood pressure medication', 'Antihypertensives', 2, 18.00, 9.00, 100, 30),
(5, 'MED-005', 'Cetirizine 10mg', 'Antihistamine for allergies', 'Antihistamines', 3, 8.00, 4.00, 300, 80);
