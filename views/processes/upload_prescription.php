...
<div style="flex:1">
<div style="font-size:14px;font-weight:700;color:var(--text)">Patient: <?php echo htmlspecialchars($rx['patient_name']); ?></div>
...
<?php echo htmlspecialchars($rx['rejection_remarks']); ?>
<br><br>
<em style="color:var(--text2)">Please re-upload your prescription with the corrections. Once verified, you can proceed with dispensing.</em>
</div>
<?php endif; ?>
</div>
